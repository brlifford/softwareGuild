...
namespace SystemIO.Tests
{
    ...
    {
        private const string _filePath = @"C:\Users\brlif\Documents\repos\brad-lifford-personal-repo\SystemIO\StudentTest.txt";
        private const string _originalData = @"C:\Users\brlif\Documents\repos\brad-lifford-personal-repo\SystemIO\StudentTestSeed.txt";
