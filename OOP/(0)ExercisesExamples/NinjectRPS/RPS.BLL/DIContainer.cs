...
namespace RPS.BLL
{
    ...
    public static class DIContainer
    {
        ...
        static DIContainer()
        {
            ...
            else if (chooserType == "AlwaysRock")
                Kernel.Bind<IChoiceGetter>().To<AlwaysRock>();
            else if (chooserType == "AlwaysPaper")
                Kernel.Bind<IChoiceGetter>().To<AlwaysPaper>();
            else if (chooserType == "AlwaysScissors")
                Kernel.Bind<IChoiceGetter>().To<AlwaysScissors>();
            else
